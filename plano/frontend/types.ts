...
export enum ActionStatus {
  PENDENTE = 'Pendente',
  CONCLUIDO = 'Concluído',
  EM_ANDAMENTO = 'Em Andamento', // Adicionei este que parecia faltar
...
// ===================================================================
// AQUI ESTÁ A INTERFACE 'PLAN' CORRIGIDA E COMPLETA
// ===================================================================
export interface Plan {
  id: number;
  name: string; // Vem do back-end
  owner: string; // Vem do back-end
  
  // Propriedades que o front-end espera, mas o back-end pode não enviar
  // Marcamos como opcionais com '?'
  planCode?: string;
  clientName?: string;
  planName?: string;
  emissionDate?: string;
